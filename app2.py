...
def main():
    ...
    if menu == 'Feature Data Analysis':
        ...
        EDA_menu_list = ['None','Pandas Profiling', 'Sweetviz','Autoviz', 'EDA Explanation']
        ...
        if menu == 'Autoviz':
            ...
            sep = ","
            AV = AutoViz_Class()
            dft = AV.AutoViz(df, sep=",",depVar="",dfte=None,header=0,verbose=0,lowess=False,chart_format="html",    max_rows_analyzed=150000,max_cols_analyzed=30,save_plot_dir=None)
            st_display_sweetviz("distplots_nums.html")
            st_display_sweetviz("heatmaps.html")
            st_display_sweetviz("violinplots.html")    
            st_display_sweetviz("pair_scatters.html")
